...
public class UserController {
	...
	public String getUserOrdersByReqParam(@RequestParam String userId) {
		...
		final String uri = "http://Order-Service/demo/orders/byparam";
	...
	public ResponseEntity<String> testPostWithParam() {

		String uri = "http://Order-Service/demo/orders/byparam";
	...
	public ResponseEntity<String> testReqBody() throws JSONException {
		String uri = "http://Order-Service/demo/orders/bybody";
		...
		request.put("id", 110);
		request.put("description", "test10");
